  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
        <div className="text-2xl font-bold text-green-700">Viatornet</div>
...
const tours = [
  { title: "Eiffel Tower Tour", location: "Paris", img: "/tower.webp" },
  { title: "Great Wall Hike", location: "Beijing", img: "/wall.webp" },
  { title: "Desert Safari", location: "Dubai", img: "/desert.webp" },
];
